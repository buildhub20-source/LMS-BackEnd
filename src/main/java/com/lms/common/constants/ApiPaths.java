...
public final class ApiPaths {
    ...
    public static final String BATCHES     = API_V1 + "/batches";
    public static final String INSTRUCTORS = API_V1 + "/instructors";
    ...
    public static final String CERTIFICATES = API_V1 + "/certificates";
